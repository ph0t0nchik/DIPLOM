...
namespace Server.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> SetLog([FromQuery] string logEntry, [FromQuery] string window = null, [FromQuery] string computer = "Этот компьютер", [FromQuery] DateTime? time = null)
        {
            try
            {
